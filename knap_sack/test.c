...
void ks_dynamic_test0() {
    printf("=== ks_dynamic_test0 ===\n");
    int n = 1;
    int w = 0;
    int weights[n];
    int values[n];
...
void ks_dymanic_test1() {
    printf("===  ks_dymanic_test1 ===\n");
    int n = 3;
    int w = 4;
    int weights[3] = {2, 2, 3};
    int values[3] = {2, 2, 3};
